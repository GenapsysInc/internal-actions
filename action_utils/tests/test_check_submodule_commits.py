...
@pytest.fixture("git_submodule_1")
...
@pytest.fixture("git_submodule_2")
...
@pytest.fixture("git_submodule_3")
...
@pytest.fixture("git_submodule_4")
...
@pytest.fixture("github_commits_1")
def fixture_github_commits_1():
    pass


@pytest.fixture("github_commits_2")
def fixture_github_commits_2():
    pass


@pytest.fixture("github_submodule_1")
def fixture_github_submodule_1():
    pass


@pytest.fixture("github_submodule_2")
def fixture_github_submodule_2():
    pass


@pytest.fixture("github_submodule_3")
def fixture_github_submodule_3():
    pass


@pytest.fixture("github_submodule_4")
def fixture_github_submodule_4():
    pass


@pytest.fixture("github_repo_all_valid")
def fixture_github_repo_all_valid():
    pass


@pytest.fixture("github_repo_all_invalid")
def fixture_github_repo_all_invalid():
    pass


@pytest.fixture("github_repo_mixed")
