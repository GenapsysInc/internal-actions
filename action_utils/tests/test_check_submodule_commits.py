...
def fixture_git_submodule_1():
    return gpy_utils.MockGitSubmodule(f"git@github.com:{TEST_ORG}/{SUBMOD_1}",
                                      "c6ab5c34293c5d4c4b845ff1fb43b6c1a14efc0f")


@pytest.fixture(name="git_submodule_2")
def fixture_git_submodule_2():
    return gpy_utils.MockGitSubmodule(f"git@github.com:{TEST_ORG}/{SUBMOD_2}",
                                      "605ec24162595201e00bf749142049049e886b38")


@pytest.fixture(name="git_submodule_3")
def fixture_git_submodule_3():
    return gpy_utils.MockGitSubmodule(f"git@github.com:{TEST_ORG}/{SUBMOD_3}",
                                      "cc1094a52793eef40bf7fcc55186d7d25a91057f")


@pytest.fixture(name="git_submodule_4")
def fixture_git_submodule_4():
    return gpy_utils.MockGitSubmodule(f"git@github.com:{TEST_ORG}/{SUBMOD_4}",
                                      "5ed147fe12ec412b484c8ec7fd44bf550e454b13")
